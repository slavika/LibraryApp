...
import com.libraryApp.controller.BookController;
...
import com.libraryApp.util.JsonUtil;
...
class BookControllerTest {
    ...
    private static final List<BookEntity> libraryEntities = library.stream().map(BookMapper.INSTANCE::bookRepToEntity).collect(Collectors.toList());
    ...
    class CRUDTests {
        ...
        void should_AddBookToLibrary_When_BookRepIsOk() throws Exception {
            BookEntity bookEntityToAdd = libraryEntities.get(4);
            Mockito.when(libraryService.checkSignatureAndAddBook(bookEntityToAdd)).thenReturn(bookEntityToAdd);

            mockMvc.perform(MockMvcRequestBuilders
                            .post("/library/books")
                            .content(JsonUtil.mapToJson(bookEntityToAdd))
        ...
        void should_AddListOfBooksToLibrary_When_CorrectListOfBooksGiven() throws Exception {
            Mockito.when(libraryService.checkSignaturesAndAddBooks(libraryEntities)).thenReturn(libraryEntities);

            mockMvc.perform(MockMvcRequestBuilders
                            .post("/library/books-by-list")
                            .content(JsonUtil.mapToJson(libraryEntities))
                            .contentType(MediaType.APPLICATION_JSON))
                    .andExpect(status().isCreated())
        ...
        void should_UpdateBook_When_BookIdExists() throws Exception {
            ...
            BookEntity updatedBookEntity = BookMapper.INSTANCE.bookRepToEntity(updatedBookRepresentation);
            Mockito.when(libraryService.checkIdAndUpdateBook(1, updatedBookEntity)).thenReturn(updatedBookEntity);
        ...
        void should_RateABook_When_BookIdExists() throws Exception {
            ...
            BookEntity ratedBookEntity = BookMapper.INSTANCE.bookRepToEntity(ratedBookRepresentation);

            Mockito.when(libraryService.checkIdAndRateABook(1, 2)).thenReturn(ratedBookEntity);
    ...
    class ReturnFilteredBooksTests {
        ...
        void should_ReturnAllBooks_When_LibraryNotEmpty() throws Exception {
            Mockito.when(libraryService.getAllBooks()).thenReturn(libraryEntities);
        ...
        void should_ReturnBook_When_BookIdExists() throws Exception {
            Mockito.when(libraryService.getBookById(1)).thenReturn(libraryEntities.get(0));
        ...
        void should_ReturnBooksByTitle_When_TitleExists() throws Exception {
            String title = "Diune";
            Mockito.when(libraryService.getBookByTitle(title)).thenReturn(Collections.singletonList(libraryEntities.get(3)));
        ...
        void should_ReturnBooksByGenre_When_GenreExists() throws Exception {
            ...
            List<BookEntity> filteredBookEntities = filteredBookRepresentations.stream().map(BookMapper.INSTANCE::bookRepToEntity).collect(Collectors.toList());

            Mockito.when(libraryService.getBooksByGenre(genre)).thenReturn(filteredBookEntities);
        ...
        void should_ReturnMostPopularBook_When_ThereIsOne() throws Exception {
            addRatesAndScores();
            Mockito.when(libraryService.getMostPopularBook()).thenReturn(Collections.singletonList(libraryEntities.get(4)));
        ...
        void should_ReturnHighestRatedBook_When_ExistsOne() throws Exception {
            addRatesAndScores();
            Mockito.when(libraryService.getHighestRatedBook()).thenReturn(Collections.singletonList(libraryEntities.get(2)));
    ...
    class SortingTests {
        ...
        void should_SortScoresByGenre_When_GenreExists() throws Exception {
            ...
            List<BookEntity> sortedBookEntities = sortedBookRepresentations.stream().map(BookMapper.INSTANCE::bookRepToEntity).collect(Collectors.toList());

            Mockito.when(libraryService.getSortedScoreByGenre(genre)).thenReturn(sortedBookEntities);
        ...
        void should_SortBooksByAuthor() throws Exception {
            ...
            Mockito.when(libraryService.sortBooksByAuthor()).thenReturn(sortedBookEntities);
        ...
        void should_SortBooksByTitle() throws Exception {
            ...
            Mockito.when(libraryService.sortBooksByTitle()).thenReturn(sortedBookEntities);
        ...
        void should_SortBooksByScoreAscending() throws Exception {
            ...
            Mockito.when(libraryService.sortBooksByScoreAscending()).thenReturn(sortedBookEntities);
        ...
        void should_SortBooksByScoreDescending() throws Exception {
            ...
            Mockito.when(libraryService.sortBooksByScoreDescending()).thenReturn(sortedBookEntities);
    ...
    class ExceptionTests {
        ...
        void should_ThrowExceptionOnAddingDuplicateBookToLibrary_When_BookAlreadyExists() throws Exception {
            ...
            BookEntity bookEntityToAdd = BookMapper.INSTANCE.bookRepToEntity(bookRepresentationToAdd);

            Mockito.when(libraryService.checkSignatureAndAddBook(bookEntityToAdd)).thenThrow(new Exception());
        ...
        void should_ThrowExceptionOnUpdating_When_BookIdDoesNotExist() throws Exception {
            ...
            Mockito.when(libraryService.checkIdAndUpdateBook(10, updatedBookEntity)).thenThrow(new NoSuchElementException());
        ...
        void should_ThrowExceptionOnAddingBook_When_BookFromListAlreadyExists() throws Exception {
            Mockito.when(libraryService.checkSignaturesAndAddBooks(libraryEntities)).thenThrow(new Exception());
