...
class ErrorControllerTest {
    ...
    void should_ThrowValidationError_When_SignatureMissing() throws Exception {
        BookEntity bookEntity = BookMapper.INSTANCE.bookRepToEntity(new BookRepresentation(1, "","LOTR", "Tolkien", "Desc", "fantasy"));


        Mockito.when(libraryService.checkSignatureAndAddBook(bookEntity)).thenThrow(new BindException());
